import { ChevronDown, Instagram, ShoppingCart } from '../components/icons.tsx';
...
export function LandingPage(props?: Props) {
  ...
  const h = {
    ...
    description:
      'Zamawiaj to, co zwykle – wygodnie, cyklicznie i bez stresu. Produkty dla Ciebie, dzieci, zwierząt i Twojego domu. Zgodnie z Twoim harmonogramem.',
  };
        ...
        <footer class='bg-[#2B2B2B] px-6 py-4'>
          <div class='max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0'>
            ...
            <ul class='flex items-center gap-4'>
              ...
              <li>
                <a
                  href='https://www.facebook.com/profile.php?id=61578888749223'
